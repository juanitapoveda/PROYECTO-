...
def duracion_promedio_peliculas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict) -> str:
    ...
    #aqui accedemos a la parte de duracion del diccionario de cada pelicula.
    #se suman las duraciones y se divide entre 5.
    #el resultado se guarda en la variable promedio.
    
    print("La duracion promedio de las peliculas es: " + str(promedio) + " mins")
    #se usa el print para mostrar en pantalla.
    #se concatena texto con el valor numérico convertido a cadena con el "str"
